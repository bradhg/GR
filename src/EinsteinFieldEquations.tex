...
\begin{document}
    ...
    \[
        R_{𝜇𝜈} - ½\,g_{𝜇𝜈}\,R = \frac{8\,π\,G}{c^4} T_{𝜇𝜈}
    \]
    ...
    \begin{table}[h!]
        ...
        \begin{tabularx}{\linewidth}{>{$}c<{$} L L >{$}l<{$}}
            ...
            \midrule
            R_{𝜇𝜈}  & Ricci tensor                     & curvature              & L^{-2} \\
            g_{𝜇𝜈}  & Metric tensor                    & dimensionless          & \text{—} \\
            R       & Ricci scalar                     & curvature              & L^{-2} \\
            G       & Universal constant               & gravitational coupling & L^{3}\,M^{-1}\,T^{-2} \\
            c       & Speed of light                   & speed                  & L\,T^{-1} \\
            T_{𝜇𝜈}  & Stress\text{--}energy tensor     & energy density         & M\,L^{-1}\,T^{-2} \\
            \bottomrule
        \end{tabularx}
    \end{table}

    \subsection{Stress–energy tensor $T_{𝜇𝜈}$}
    ...
    \[
        𝛤^𝜌_{𝜇𝜈} = ½ g^{𝜌\O𝜎} \left( \pg{𝜇𝜈{\O𝜎}} + \pg{𝜈𝜇{\O𝜎}} -  \pg{{\O𝜎}𝜇𝜈} \right)
    \]
    ...
    \[
        R^𝛼_{𝜇𝛽𝜈} = ∂_{𝛽}\,𝛤^{𝛼}_{𝜇𝜈} - ∂_{𝜈}\,𝛤^{𝛼}_{𝜇𝛽} + 𝛤^{𝛼}_{𝜇𝜈}\,𝛤^{\G𝜌}_{𝛽\G𝜌} - 𝛤^{𝛼}_{𝜇\G𝜌}\,𝛤^{\G𝜌}_{𝛽𝜈}
    \]
    ...
    \[
        R_{𝜇𝜈} = ∂_{\O𝜆}\,𝛤^{\O𝜆}_{𝜇𝜈} - ∂_{𝜈}\,𝛤^{\O𝜆}_{𝜇\O𝜆} + 𝛤^{\O𝜆}_{𝜇𝜈}\,𝛤^{\G𝜌}_{\O𝜆\G𝜌} - 𝛤^{\O𝜆}_{𝜇\G𝜌}\,𝛤^{\G𝜌}_{\O𝜆𝜈}
    \]
